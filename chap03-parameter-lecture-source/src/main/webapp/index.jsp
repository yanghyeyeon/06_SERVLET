...
<body>
    ...
    <h4>a태그의 href 속성이 파라미터를 쿼리스트링 형태로 작성하여 get 방식 요청</h4>
    <a href="http://localhost:8080/querystring?name=%ED%99%8D%EA%B8%B8%EB%8F%99&age=23&birthday=2004-07-01&gender=M&national=ko&hobbies=music&hobbies=sleep">
        쿼리스트링을 이용한 값 전달
    </a>
</body>
</html>